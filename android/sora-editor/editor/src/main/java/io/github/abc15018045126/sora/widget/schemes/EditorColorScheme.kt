 ...
 * @author Rose
 */
open class EditorColorScheme
    @JvmOverloads
    constructor(private val dark: Boolean = false) {
        /**
         * Real color saver
         */
        @JvmField
        ...
        companion object {
            ...
            @JvmStatic
            fun setDefault(
                @Nullable colorScheme: EditorColorScheme?,
            ) {
