 ...
 * @see Builder
 */
class MappedSpans private constructor(
    @NonNull private val spanMap: MutableList<MutableList<Span>>,
) : Spans {
    ...
    class Builder
        @JvmOverloads
        constructor(lineCapacity: Int = 128) {
