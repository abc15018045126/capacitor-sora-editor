 ...
 * @author Rose
 */
internal class CursorBlink(val editor: CodeEditor, period: Int) : Runnable, EventReceiver<SelectionChangeEvent> {

    @JvmField
    var visibility: Boolean = true
    @JvmField
    var valid: Boolean = false
    private var lastSelectionModificationTime: Long = 0
    @JvmField
