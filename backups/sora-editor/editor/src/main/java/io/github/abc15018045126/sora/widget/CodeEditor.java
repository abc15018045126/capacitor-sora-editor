...
public class CodeEditor extends View implements ContentListener, Formatter.FormatResultReceiver, InlayHintRendererProvider {
    ...
    public <T extends EditorBuiltinComponent> void replaceComponent(@NonNull Class<T> clazz, @NonNull T replacement) {
        var old = <EditorBuiltinComponent>getComponent(clazz);
    ...
    protected void applyAttributeSets(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        <T>getComponent(EditorAutoCompletion.class).setEnabled(array.getBoolean(R.styleable.CodeEditor_autoCompleteEnabled, true));
    ...
    protected void setTextSizePxDirect(@Px float size) {
        ...
        <Event>dispatchEvent(new TextSizeChangeEvent(this, oldTextSize, size));
    }
    ...
    public void ensurePositionVisible(int line, int column, boolean noAnimation) {
        ...
        <Event>dispatchEvent(new ScrollEvent(this, getOffsetX(),
    ...
    public void setLayoutBusy(boolean busy) {
        if (layoutBusy && !busy) {
            if (wordwrap && touchHandler.positionNotApplied) {
                ...
                <Event>dispatchEvent(new ScrollEvent(this, scroller.getCurrX(),
            ...
            restartInput();
            postInvalidate();
            <Event>dispatchEvent(new LayoutStateChangeEvent(this, false));
            return;
        }
        if (layoutBusy == busy) {
            return;
        ...
        <Event>dispatchEvent(new LayoutStateChangeEvent(this, busy));
    }
    ...
    public void setText(@Nullable CharSequence text, boolean reuseContentObject,
        ...
        <Event>dispatchEvent(new ContentChangeEvent(this, ContentChangeEvent.ACTION_SET_NEW_TEXT, new CharPosition(), this.text.getIndexer().getCharPosition(getLineCount() - 1, this.text.getColumnCount(getLineCount() - 1)), this.text, false));
        createLayout();
    ...
    public void release() {
        hideEditorWindows();
        if (!released) {
            <Event>dispatchEvent(new EditorReleaseEvent(this));
        } else {
            return;
        }
        released = true;
    ...
    public void onColorUpdated(int type) {
        <Event>dispatchEvent(new ColorSchemeUpdateEvent(this));
        renderContext.invalidateRenderNodes();
        invalidate();
    }
    ...
    protected void onSelectionChanged(int cause) {
        ...
        <Event>dispatchEvent(new SelectionChangeEvent(this, oldLeft, oldRight, cause));
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        <Event>dispatchEvent(new BuildEditorInfoEvent(this, outAttrs));
        inputConnection.reset();
        text.resetBatchEdit();
        setExtracting(null);
    ...
    protected void onCreateContextMenu(ContextMenu menu) {
        ...
        <Event>dispatchEvent(new CreateContextMenuEvent(this, menu, text.getIndexer().getCharPosition(IntPair.getFirst(charPos), IntPair.getSecond(charPos))));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        <Event>dispatchEvent(new EditorAttachStateChangeEvent(this, false));
    ...
    protected void onAttachedToWindow() {
        ...
        <Event>dispatchEvent(new EditorAttachStateChangeEvent(this, true));
    }
    ...
    protected void onFocusChanged(boolean gainFocus, int direction,
        ...
        <Event>dispatchEvent(new EditorFocusChangeEvent(this, gainFocus));
        invalidate();
    }
    ...
    public void afterInsert(@NonNull Content content, int startLine, int startColumn, int endLine,
        ...
        <Event>dispatchEvent(new ContentChangeEvent(this, ContentChangeEvent.ACTION_INSERT, start, end, insertedContent, text.isUndoManagerWorking()));
    ...
    public void afterDelete(@NonNull Content content, int startLine, int startColumn, int endLine,
        ...
        selectionAnchor = lastAnchorIsSelLeft ? cursor.left() : cursor.right();
        <Event>dispatchEvent(new ContentChangeEvent(this, ContentChangeEvent.ACTION_DELETE, start, end, deletedContent, text.isUndoManagerWorking()));
        onSelectionChanged(SelectionChangeEvent.CAUSE_TEXT_MODIFICATION);
    ...
    public void onFormatSucceed(@NonNull CharSequence applyContent, @Nullable TextRange
        ...
        postInLifecycle(() -> {
            ...
            inputConnection.reset();
            restartInput();
            <Event>dispatchEvent(new EditorFormatEvent(this, true));
        });
    }
    ...
    public void onFormatFail(final Throwable throwable) {
        postInLifecycle(() -> {
            ...
            <Event>dispatchEvent(new EditorFormatEvent(this, false));
        });
    }
